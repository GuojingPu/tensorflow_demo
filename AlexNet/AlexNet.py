...
W_conv = {
    'conv1':weight_variable([11,11,3,96],stddev=0.0001),
    'conv2':weight_variable([5,5,96,256],stddev=0.01),
    'conv3': weight_variable([3, 3, 256, 384], stddev=0.01),
    'conv4': weight_variable([3, 3, 384, 384], stddev=0.01),
    'conv5': weight_variable([3, 3, 384, 256], stddev=0.01),
    'fc1':weight_variable([13*13*256,4096],stddev=0.1),
    'fc2':weight_variable([4096,2048],stddev=0.1),
    'fc3':weight_variable([2048,2],stddev=0.1),
}

b_conv = {
    'conv1':bias_varible(0.0,shape=[96]),
    'conv2':bias_varible(0.1,shape=[156]),
    'conv3': bias_varible(0.1, shape=[384]),
    'conv4': bias_varible(0.1, shape=[384]),
    'conv5': bias_varible(0.1, shape=[256]),
    'fc1':bias_varible(0.1,shape=[4096]),
    'fc2':bias_varible(0.1,shape=[2048]),
    'fc3':bias_varible(0.0,shape=[2])
}
